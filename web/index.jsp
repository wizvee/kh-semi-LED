			...
			<div id="pop_wrap">
				...
				<div id="pop_container">
					...
					<form method="post" class="frm_login active">
						<div>
							<input type="email" name="userEmail" class="inpt-gradient"
								required /> <span data-placeholder="이메일"></span>
						</div>
						<div>
							<input type="password" name="userPw" class="inpt-gradient"
								required /> <span data-placeholder="비밀번호"></span>
						</div>
						<div>
							<button class="btn-gradient"
								onclick="login_validate(); return false;">로그인</button>
						</div>
						<div class="option_area">
							<input type="checkbox" name="" id="ck_keep" /> <label
								for="ck_keep">로그인 유지</label> <a href="#">비밀번호 찾기</a>
						</div>
						<div class="msg_area"></div>
						<div>
							<button id="btn_fb" class="btn-primary">
								<i class="fa fa-facebook-square" aria-hidden="true"></i> 페이스북으로
								로그인
							</button>
						</div>
						<div>
							<button id="btn_gg" class="btn-primary">
								<i class="fa fa-google-plus-square" aria-hidden="true"></i> 구글로
								로그인
							</button>
						</div>
					</form>
					...
					<form method="post" class="frm_register">
						<div>
							<input type="email" name="userEmail" class="inpt-gradient"
								id="uMail" required /> <span data-placeholder="이메일"></span>
						</div>
						<div>
							<input type="password" name="userPw" class="inpt-gradient"
								id="pw1" required /> <span data-placeholder="비밀번호"></span>
						</div>
						<div>
							<input type="password" name="pw2" class="inpt-gradient" id="pw2"
								required /> <span data-placeholder="비밀번호"></span>
						</div>
						<div>
						...
						<div>
							...
							<span data-placeholder="핸드폰"></span>
						</div>
						<div>
							<button class="btn-gradient"
								onclick="sign_validate(); return false;">회원가입</button>
						</div>
						<div class="msg_area"></div>
					</form>
					<!-- // 회원가입 폼 -->
