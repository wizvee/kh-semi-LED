...
public class Attendance {
   ...
   public Attendance(String busId, String empId, String userName, String sftId, String sftName, String sftOn,
         String sftOff, String[] atdType, String atdOn, String atdOff, int empWage, String empType, long stAtdTime,
         long enAtdTime, long stSftTime, long enSftTime) {
      super();
      this.busId = busId;
      this.empId = empId;
   ...
   public String toString() {
      return "Attendance [busId=" + busId + ", empId=" + empId + ", userName=" + userName + ", sftId=" + sftId
            + ", sftName=" + sftName + ", sftOn=" + sftOn + ", sftOff=" + sftOff + ", atdType="
            + Arrays.toString(atdType) + ", atdOn=" + atdOn + ", atdOff=" + atdOff + ", empWage=" + empWage
            + ", empType=" + empType + ", stAtdTime=" + stAtdTime + ", enAtdTime=" + enAtdTime + ", stSftTime="
            + stSftTime + ", enSftTime=" + enSftTime + "]";
   }
