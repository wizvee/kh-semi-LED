 ...
 */
@WebServlet("/ajaxowneroriproFile.do")
public class ChangeAjaxinfoOwnerOriginloadServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ChangeAjaxinfoOwnerOriginloadServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int result = new UserService().OwneroriginPic(userId);
